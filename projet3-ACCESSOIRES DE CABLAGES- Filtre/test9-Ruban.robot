...
filtrer les produits by attribute
                ...
                sleep       5
                select from list by index                      xpath://body/div[@id='wrapper']/main[@id='main']/div[1]/div[1]/div[1]/aside[1]/div[2]/div[2]/div[2]/select[1]           3
                sleep       5
                ...
                wait until element is visible                   xpath://a[contains(text(),'Ruban adhesif jaune')]
                sleep       5